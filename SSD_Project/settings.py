...
def get_secret_key():
    try:
        # Try to read the secret key from the environment variable
        return os.environ['DJANGO_SECRET_KEY']
    except KeyError:
        # If the environment variable is not set, generate a new secret key
...
ALLOWED_HOSTS = ['reservespot.zapto.org']
...
MIDDLEWARE = [
    ...
    'ReserveSpot.custom_middleware.AdminRoleRestrictionMiddleware'
]
